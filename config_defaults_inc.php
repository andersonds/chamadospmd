 ...
 */
$g_webmaster_email		= 'anderson.silva@diadema.sp.gov.br';

/**
 * the sender email, part of 'From: ' header in emails
 * @global string $g_from_email
 */
$g_from_email			= 'anderson.silva@diadema.sp.gov.br';
 ...
 */
$g_return_path_email	= 'anderson.silva@diadema.sp.gov.br';
